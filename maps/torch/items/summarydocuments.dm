...
/obj/item/documents/generic/sol/bunnybirdissues
	...
	desc = "An \"internal use only\" memo sent from the Chief Medical Officer to the Executive Officer detailing the need for downtime and recovery for bridge staff after numerous reports of certain bridge officers (whose names are redacted from the report) seeing \"giant space birds\" after too long at the helm, and reminding  them to be sent for psychological counseling at their earliest convenience."

/obj/item/documents/generic/sol/bunnytraining
	name = "bridge officer qualification status"
	desc = "An \"internal use only\" memo sent from the Commanding Officer to the heads of staff reminding them that bridge officers are qualified in communications and bridge operations only and do not, in fact, double as naval infantry. They should not be deployed like such during minor security incidents, citing numerous reports of broken legs and feet being shot due to mishandling of weapons."
...
/obj/item/documents/generic/corp/coffeecut
	...
	desc = "A \"confidential\" memo on the current usage of funds provided to SEV Torch corporate liaisons; apparently there's threats of a strike over a cut to the coffee budget by the head office."
...
/obj/item/documents/generic/corp/exointerest2
	name = "RE: EXO and you"
	desc = "A \"confidential\" memo directed to all Helios corporate liasions that highlights several instances of corporate liasons going above their authority on Helios project vessels. It reinforces that corporate liasons are not aboard the vessels to make decisions on behalf of the EXO board of directors, and ends by requesting that all liasions re-read the original memo titled \"EXO and you\"."
